...
public class BaseLoadingService<T extends ILightEntity> 
{
	...
	/**
	 * The associated bean manager. Default value is defined by the unique
	 * instance of the singleton.
	 */
	private PersistentBeanManager beanManager = PersistentBeanManager
			.getInstance();
	...
	public <K extends ILightEntity> K loadEntityAssociation(T parent,
			String propertyName) {
	 ...
	 * 
	 * @see
	 * net.sf.gilead.gwt.client.LoadingService#loadAssociationList(net.sf.gilead
	 * .pojo.base.ILightEntity, java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @see
	 * net.sf.gilead.gwt.client.LoadingService#loadSetAssociation(net.sf.gilead
	 * .pojo.base.ILightEntity, java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	...
	public T loadEntity(String className, Serializable id) {
		...
		if (persistenceUtil == null) {
			throw new NullPointerException(
					"Persistence util not set on beanManager field !");
		}
	...
	protected Object loadAssociation(T parent, String propertyName) {
		...
		if (_log.isDebugEnabled()) {
			_log.debug("Loading property " + propertyName + " for entity "
					+ parent);
		}
