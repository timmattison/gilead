...
public class ExplicitClassMapper implements IClassMapper
{
	...
	//-------------------------------------------------------------------------
	/**
	 * Add an association between source- and Clone-Class<?>, where source is the 
	 * domain class that shall be cloned to the given clone class, in order to
	 * be transferable via gwt to the client. 
	...
	/**
	 * Set the associations between source- and Clone-Class<?>. All previous association get 
	 * deleted.
