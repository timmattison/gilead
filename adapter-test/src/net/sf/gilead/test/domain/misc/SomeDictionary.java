...
public class SomeDictionary implements Serializable {
    ...
    public static class PrimaryKey implements Serializable {
        ...
        @Column(name="BASE_DICTIONARY_ID", nullable=false, updatable=false,
                precision=2)
    ...
    @JoinColumn(name="BASE_DICTIONARY_ID", nullable=false, insertable=false,
            updatable=false)
    ...
    @JoinColumns({
        @JoinColumn(name="PARENT_ID", 
                ...
                updatable=false),
        @JoinColumn(name="PARENT_BASE_DICTIONARY_ID", 
                referencedColumnName="BASE_DICTIONARY_ID", 
                updatable=false)
    })
