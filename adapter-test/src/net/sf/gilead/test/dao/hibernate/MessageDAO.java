...
{    
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.gilead.testApplication.server.dao.IMessageDAO#saveMessage(net.sf.gilead.testApplication.domain.IMessage)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.gilead.testApplication.server.dao.IMessageDAO#lockMessage(net.sf.gilead.testApplication.domain.IMessage)
	 */
