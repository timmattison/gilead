...
/**
 * Clone test for dynamic proxy mode (Java 1.4)
 * @author bruno.marchesson
 *
 */
public class Java14DynamicProxyCloneTest extends CloneTest
{	
	/**
	 * Test setup
	 */
	...
	//
		...
		if ((cloneMessageClass != null) &&
			(cloneMessageClass.getName().endsWith(additionalCode.getSuffix()) == false))
		{
	...
	{
		((net.sf.gilead.test.domain.proxy.Message)message).
			setAuthor((net.sf.gilead.test.domain.proxy.User)user);
	}
