...
public class Java5SupportCloneTest extends CloneTest
{
	...
	{
		((net.sf.gilead.test.domain.dto.MessageDTO)message).
			setAuthor((net.sf.gilead.test.domain.dto.UserDTO)user);
	}
	...
	{
		((net.sf.gilead.test.domain.java5.Message)message).
			setAuthor((net.sf.gilead.test.domain.java5.User)user);
	}
}
