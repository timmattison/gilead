...
public class Timestamp extends java.util.Date implements Cloneable, Comparable{
  ...
  public Timestamp(int year, int month, int date, int hrs, int min, int sec, int nanos) {
    init(year, month, date, hrs, min, sec, nanos);
  }
  ...
  public Object clone() {
    Timestamp clone = new Timestamp(getTime());
    clone.setNanos(getNanos());
    return clone;
  }
  ...
  public boolean equals(Object obj) {
    return ((obj instanceof Timestamp) && 
    		(getTime() == ((Timestamp) obj).getTime()) &&
    		(getNanos() == ((Timestamp) obj).getNanos()));
  }
  ...
  public native void setNanos(int nanos) /*-{
    this.nanos = nanos;
  }-*/;
  ...
  public native String toString() /*-{
    var d = this.jsdate;
    var padTwo = @java.sql.Timestamp::padTwo(I);
    var day =
        @java.sql.Timestamp::dayToString(I)(this.jsdate.getDay());
    var month =
        @java.sql.Timestamp::monthToString(I)(this.jsdate.getMonth());
